...
while z <= 28:
    ...
    # futbolcu ismi
    selected_elements_1 = dom.xpath(f"//*[@id='stats_defense_9']/tbody/tr[{z}]/th/a")
    ...
    while i <= 21:
        ...
        selected_elements = dom.xpath(f"(//*[@id='stats_defense_9']/tbody/tr)[{z}]/td[{i}]")
...
df = pd.DataFrame(big_liste, columns=["Name", "Position", "Age", "Value", "Stat1", "Stat2", "Stat3", "Stat4", 
                                      "Stat5", "Stat6", "Stat7", "Stat8", "Stat9", "Stat10", "Stat1", "Stat2", "Stat3", "Stat4","Stat5", "Stat4","Stat5"])

# Excel dosyasına yaz
df.to_excel("Defensive_Actions.xlsx", index=False)
print('done')