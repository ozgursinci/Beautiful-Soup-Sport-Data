...
while z <= 38:
    ...
    # futbolcu ismi
    selected_elements_1 = dom.xpath(f"//*[@id='stats_misc_9']/tbody/tr[{z}]/th/a")
    ...
    while i <= 21:
        ...
        selected_elements = dom.xpath(f"(//*[@id='stats_misc_9']/tbody/tr)[{z}]/td[{i}]")
...
df = pd.DataFrame(big_liste, columns=["Name", "Position", "Age", "Value", "Stat1", "Stat2", "Stat3", "Stat4", 
                                      ...
                                      "Stat3", "Stat4","Stat5", "Stat4","Stat5"])

# Excel dosyasına yaz
df.to_excel("Miscellaneous_Stats.xlsx", index=False)
print('done')